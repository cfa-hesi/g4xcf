// -----------------------------------------------------------------------------
//  g4xcf | source/AnalysisManager.cpp
//
...
{
    // ROOT output file
    tfile_ = new TFile(file_path.data(), "recreate", "g4xcf");

    // metadata tree
    metadata_ = new TTree("metadata", "metadata");

    metadata_->Branch("detector_inner_radius", &detector_inner_radius_, "detector_inner_radius/D");
    metadata_->Branch("detector_outer_radius", &detector_outer_radius_, "detector_outer_radius/D");
...
//-----------------------------------------------------------------------------
void AnalysisManager::FillMetadata(double const & detector_inner_radius,
                                   double const & detector_outer_radius,
                                   double const & detector_length_z)
{
    detector_inner_radius_ = detector_inner_radius;
    detector_outer_radius_ = detector_outer_radius;
